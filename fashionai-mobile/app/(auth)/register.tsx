      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subheading}>
            ...
            <Text style={styles.subheadingLink} onPress={() => router.back()}>
              Giriş yap
            </Text>
          </Text>
          ...
          <View style={[styles.inputWrap, nameFocused && styles.inputWrapFocused]}>
            <Ionicons name="person-outline" size={17} color={nameFocused ? '#C41E3A' : 'rgba(255,255,255,0.35)'} style={styles.inputIcon} />
            <TextInput
              style={styles.input}
          ...
          >
            {loading ? (
              ...
              <>
                <Ionicons name="person-add-outline" size={17} color="#fff" style={{ marginRight: 7 }} />
